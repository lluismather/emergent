...
const ENV_DEBUG = "WIZARDING_DEBUG"
const ENV_DEBUG_PERCEPTION = "WIZARDING_DEBUG_PERCEPTION"
const ENV_DEBUG_PERCEPTION_VISUAL = "WIZARDING_DEBUG_PERCEPTION_VISUAL"
const ENV_DEBUG_UI = "WIZARDING_DEBUG_UI" 
const ENV_DEBUG_AI = "WIZARDING_DEBUG_AI"
const ENV_DEBUG_SPELLS = "WIZARDING_DEBUG_SPELLS"
const ENV_DEBUG_ENVIRONMENT = "WIZARDING_DEBUG_ENVIRONMENT"
const ENV_DEBUG_VERBOSE = "WIZARDING_DEBUG_VERBOSE"
